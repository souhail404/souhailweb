        ...
        <section>
            ...
            <div className="flex flex-col gap-12 relative p-4">
                ...
                <div className="flex flex-col gap-2">
                    <h3 className="flex items-center"> <div className="text-xs mr-2"><BsCircleFill/></div>  Professional Journey</h3>
                ...
                <div className="flex flex-col gap-2">
                    <h3 className="flex items-center"><div className="text-xs mr-2"><BsCircleFill/></div> Passion for Coding</h3>
                ...
                <div className="flex flex-col gap-2">
                    <h3 className="flex items-center"><div className="text-xs mr-2"><BsCircleFill/></div> Skills & Expertise</h3>
                ...
                <div className="flex flex-col gap-2">
                    <h3 className="flex items-center"><div className="text-xs mr-2"><BsCircleFill/></div>  Projects & Achievements</h3>
